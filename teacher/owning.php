        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <div class="table-responsive">
							<h3> Veprime: </h3><a href="owning_grades.php"><button class="button-success pure-button"  value="Vlereso" style="margin: 0px 0px 10px 0px; background:  #66ff66
;">Vlereso</button></a><button class="button-success pure-button" value="Vlereso" style="margin: 0px 0px 10px 0px; background:  blue; margin-left: 15px;">Modifiko</button>
...
<tr id="<?php echo $nxs['id_nxenes']; ?> ">
      ...
      <!-- /.container-fluid -->
			<table id="data_table" class="table table-striped">
					...
					<tbody>
						<?php
						$sql_query = "SELECT id_nxenes, emri_nxenes, vendlindje FROM nxenes LIMIT 10";
						$resultset = mysqli_query($mysqli, $sql_query) or die("database error:". mysqli_error($conn));
						while( $developer = mysqli_fetch_assoc($resultset) ) {
						?>
						   <tr id="<?php echo $developer ['id_nxenes']; ?>">
						   <td><?php echo $developer ['id_nxenes']; ?></td>
						   <td><?php echo $developer ['emri_nxenes']; ?></td>
						   <td><?php echo $developer ['vendlindje']; ?></td>
