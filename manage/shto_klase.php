...
<body id="page-top">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Shto Klase</li>
        </ol>

        <!-- Page Content -->
        <h1><?php echo $emer_mbiemer; ?></h1> <h2 class="breadcrumb-item active">| Shto Klase</h2>
        <hr>
      ...
      <div class="container">
        <form method="post">
          <div class="row">
            ...
            <div class="col-75">
              <input type="text" id="fname" name="firstname" placeholder="Klasa..">
            </div>
          </div>
          <div class="row">
            <div class="col-25">
              <label for="lname">Mesuesi/ja Kujdestare</label>
            </div>
            <div class="col-75">
              <input type="text" id="lname" name="lastname" placeholder="Mesuesi/ja Kujdestare..">
            </div>
          </div>
          <div class="row">
            <div class="col-25">
              <label for="country">Dega</label>
            </div>
            <div class="col-75">
              <select id="country" name="dega">
                <option> -- Dega --</option>
                <option value="Elektronike">Elektronike</option>
                <option value="Biznes">Biznes</option>
                <option value="Mekanike">Mekanike</option>
      ...
      <footer class="sticky-footer">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright © Regjistri 2019</span>
          </div>
        </div>
      </footer>
  ...
  <a class="scroll-to-top rounded" href="../teacher/#page-top">
